...
const LINES = [
  ...
  { text: "그래도 괜찮아.", size: "2rem", weight: 700, gap: 48 },
  { text: "하고 싶은 말 여기다 써.", size: "1.8rem", weight: 700, gap: 0 },
  { text: "대신 어른답게 바꿔줄게.", size: "1.8rem", weight: 700, gap: 0 },
  { text: "( ´͈ ꇴ `͈)੭⁾⁾·°˖✧˖°", size: "1.5rem", weight: 700, gap: 0 },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(0,0,40,0.18) 3px, rgba(0,0,40,0.18) 4px)",
          zIndex: 1,
        }}
      />
      ...
      <div
        ...
        style={{
          color: "rgba(10,10,46,0.45)",
          fontFamily: "'Byeoljari', sans-serif",
          zIndex: 4,
        }}
      >
        tap to skip
